<template>
  <div>
    ...
    <component v-for="(datas, index) in datas[0]" :key="'A' + index" :is="datas.flag" :datas="datas" :views="views">
    </component>
    <div class='module'>字体</div>
    <component v-for="(datas, index) in datas[1]" :key="'B' + index" :is="datas.flag" :datas="datas" :views="views">
    </component>
  </div>
</template>
