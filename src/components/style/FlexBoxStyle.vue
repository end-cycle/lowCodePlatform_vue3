<template>
    ...
    <div>
        ...
        <div class="margin-container">
            <div class="borderTop"><input placeholder="0" :value="views.style.marginTop.replace('px', '')"
                    @input="views.style.marginTop = $event.target.value + 'px'"></div>
            <div class="borderBt"><input placeholder="0" :value="views.style.marginBottom.replace('px', '')"
                    @input="views.style.marginBottom = $event.target.value + 'px'"></div>
            <div class="borderLf"><input placeholder="0" :value="views.style.marginLeft.replace('px', '')"
                    @input="views.style.marginLeft = $event.target.value + 'px'"></div>
            <div class="borderRt"><input placeholder="0" :value="views.style.marginRight.replace('px', '')"
                    @input="views.style.marginRight = $event.target.value + 'px'"></div>
            <div class="padding-containner">
                <div class="borderTop"><input placeholder="0" :value="views.style.paddingTop.replace('px', '')"
                        @input="views.style.paddingTop = $event.target.value + 'px'"></div>
                <div class="borderBt"><input placeholder="0" :value="views.style.paddingBottom.replace('px', '')"
                        @input="views.style.paddingBottom = $event.target.value + 'px'"></div>
                <div class="borderLf"><input placeholder="0" :value="views.style.paddingLeft.replace('px', '')"
                        @input="views.style.paddingLeft = $event.target.value + 'px'"></div>
                <div class="borderRt"><input placeholder="0" :value="views.style.paddingRight.replace('px', '')"
                        @input="views.style.paddingRight = $event.target.value + 'px'"></div>
            </div>
        </div>
        <!--8.18 hp更改(以上) -->
