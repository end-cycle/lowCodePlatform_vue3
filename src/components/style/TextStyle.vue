<template>
  <div>
    ...
    <component v-for="(datas, index) in datas[0]" :key="'First' + index" :is="datas.flag" :datas="datas" :views="views">
    </component>
    <div class='module'>文本</div>
    <component v-for="(datas, index) in datas[1]" :key="'second' + index" :is="datas.flag" :datas="datas"
      :views="views">
    </component>

    <div class='module'>定位</div>
    <component v-for="(datas, index) in datas[2]" :key="'third' + index" :is="datas.flag" :datas="datas" :views="views">
    </component>
  </div>
</template>
