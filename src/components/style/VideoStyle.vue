<template>
  <div>
    ...
    <div class='lineBox border smaller'>
      ...
      <div class="inputLine">
        <input :value="views.videoStyle.width.replace('px', '')"
          @input="views.videoStyle.width = $event.target.value + 'px'" autocomplete="off" placeholder="0">
        <span>px</span>
      </div>
    </div>
    <div class='lineBox border smaller'>
      ...
      <div class="inputLine">
        <input :value="views.videoStyle.height.replace('px', '')"
          @input="views.videoStyle.height = $event.target.value + 'px'" autocomplete="off" placeholder="0">
        <span>px</span>
      </div>
    </div>
  </div>
